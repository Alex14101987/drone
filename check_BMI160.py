...
if __name__ == "__main__":
  ...
  while True:
    ...
    # bmi.begin()
    print("gyro  :  x: %.3f rad/s,  y: %.3f rad/s,  z: %.3f rad/s"%(data['gyro']['x']*3.14/180.0,
                                                                    data['gyro']['y']*3.14/180.0,
                                                                    data['gyro']['z']*3.14/180.0),
          "accel :  x: %.3f g    ,  y: %.3f g    ,  z: %.3f g    "%(data['accel']['x']/16384.0,
                                                                    data['accel']['y']/16384.0,
                                                                    data['accel']['z']/16384.0))
    # print(data)
    # time.sleep(1)